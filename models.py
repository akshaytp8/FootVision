...
class Match(db.Model):
    ...
    # e.g. "logos/arsenal.png"
    home_logo_url = db.Column(db.String(400), nullable=True)
...
class Prediction(db.Model):
    ...
    predicted_outcome = db.Column(db.String(20), nullable=False)
