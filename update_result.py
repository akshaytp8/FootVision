    ...
    with app.app_context():
        ...
        for pred in predictions:
            ...
            goal_diff = (abs(pred.predicted_home_score - pred.predicted_away_score) ==
                         abs(HOME_SCORE - AWAY_SCORE)) and outcome
            ...
            us.correct_outcomes += 1 if (
                outcome and not exact and not goal_diff) else 0
        ...
        # Show top 5
        top = UserScore.query.order_by(
            UserScore.total_points.desc()).limit(5).all()
        print("\n🏆  Current Top 5:")
